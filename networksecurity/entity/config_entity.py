...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.ttrain_test_split_ratio: float = training_pipeline.DAT_INGESTION_TRAIN_TEST_SPLIT_RATIO
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.overfitting_underfitting_threshold:float = training_pipeline.MOEDL_TRAINER_OVER_FITTING_UNDER_FITTING_THRESHOLD
